...
selected_questions <- list(
  Group_1 = list(
    range = c(299,306,3,12,16,25,302,27,35,46) 
  ), 
  
  Group_2 = list( 
    range = c(92,298,305,149,152,158,65,91,164,227)
  ), 
  
  Group_3 = list( 
    range = c(303,294:297,135,116,300,163,304)
  ), 
  
  Group_4 = list( 
    range = c(29,117,112,123,47,1,13,74,284,241)
  )#, 
