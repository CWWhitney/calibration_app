...
server <- function(input, output, session) {
  ...
  user_info_reactives <- 
    mod_user_info_modal_server(
      id = "user_info_modal",
      modal_dialog_title_select_new_or_load = selected_language[51],
      ...
      workshop_selection_label = selected_language[54],
      user_first_name_required_label = selected_language[55],
      user_last_name_required_label = selected_language[56],
      workshop_selection_required_label = selected_language[57],
      submit_user_info_btn_label = selected_language[14],
      modal_dialog_title_load_session = selected_language[53],
